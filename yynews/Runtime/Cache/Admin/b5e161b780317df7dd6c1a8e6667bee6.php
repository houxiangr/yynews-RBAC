            ...
            <div id="listRifht">
                ...
                <div id="catManTable">
                   <table id="cm_table" border="1" >
                    ...
                    <?php
 foreach($adminData as $row){ $i=1; $adminName=$row["username"]; $role=$row["role_name"]; $create_time=$row["create_time"]; $updata_time=$row["updata_time"]; echo "<tr>
                        <td align='center'>$i</td>
                        <td align='center'>$adminName</td>
                        <td align='center'>$role</td>
                        <td align='center'>$create_time</td>
                        <td align='center'>$updata_time</td>
                        <td align='center'><a href='/yynews/index.php/Admin/RBAC/adminManager?adminName=$adminName'>删除</a>
                        <a href='/yynews/index.php/Admin/RBAC/userModify/adminName/$adminName'>修改</a></td>
                        </tr>"; $i++; } ?>
                </table>
            </div>
        </div>
