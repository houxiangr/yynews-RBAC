    ...
    <body>
       ...
       <div id="nav_search">
            <ul id="nav">
                ...
                <li class='tooltip'>
                <a href='/yynews/index.php/Admin/Power/commentManager' class="selected">评论管理</a>
                </li>
                 <li class='tooltip'>
                    ...
                    <table id="cm_table" border="1" >
                     <thead>
                        <tr>
                            ...
                            <td align="center">评论地址</td>
                            <td align="center">操作</td>
                        </tr>
                    </thead>
                    <?php
 foreach($tempcomments1 as $row){ $commentsId=$row["commid"]; $ip=$row["userip"]; $content=$row["content"]; $time=date("Y-m-d H:i:s",$row["createtime"]); echo "<tr>
                        <td align='center'>$commentsId</td>
                        <td align='center'>$content</td>
                        <td align='center'>$time</td>
                        <td align='center'>$ip</td>
                        <td align='center'><a href='/yynews/index.php/Admin/Power/commentManager?commId=$commentsId'>删除</a></td>
                        </tr>"; } ?>
                </table>
            </div>
